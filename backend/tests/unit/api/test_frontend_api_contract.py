...
def test_current_frontend_http_api_contract_is_registered() -> None:
    ...
    expected = {
        ...
        ("GET", "/api/v1/broker-accounts/{account_id}/risk-config"),
        ("PUT", "/api/v1/broker-accounts/{account_id}/risk-config"),
        ("GET", "/api/v1/broker-accounts/{account_id}/restrictions"),
        ("PUT", "/api/v1/broker-accounts/{account_id}/restrictions"),
        ...
        ("GET", "/api/v1/strategies/v4/"),
        ("POST", "/api/v1/strategies/v4/"),
        ("POST", "/api/v1/strategies/v4/draft"),
        ("GET", "/api/v1/strategies/v4/{strategy_version_v4_id}"),
        ("GET", "/api/v1/strategies/v4/by-strategy/{strategy_v4_id}"),
        ("PUT", "/api/v1/strategies/v4/by-strategy/{strategy_v4_id}"),
        ("DELETE", "/api/v1/strategies/v4/by-strategy/{strategy_v4_id}"),
        ("POST", "/api/v1/strategies/v4/{strategy_version_v4_id}/duplicate"),
        ("POST", "/api/v1/strategies/v4/ai-fill"),
